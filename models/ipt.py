...
class ipt(nn.Module):
    def __init__(self, conv=common.default_conv):
        ...
        self.body = VisionTransformer(img_dim=48, patch_dim=3, num_channels=n_feats, embedding_dim=n_feats*3*3, num_heads=12, num_layers=12, hidden_dim=n_feats*3*3*4, num_queries = 1, dropout_rate=0, mlp=False ,pos_every=False,no_pos=True,no_norm=False)
